...
const urlSchema = new mongoose.Schema(
  {
    ...
    // expiry: { type: Date, default: Date.now() + 24 * 60 * 60 * 1000 }, // Expiry set to 24 hours from creation
    expiry: { type: Date, default: Date.now, expires: "10s" }, // Set expiration to 10 seconds
  },
